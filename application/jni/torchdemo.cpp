...
Java_com_torchandroid_neuraltalk_lua_LuaManager_destroyTorch(JNIEnv *env, jobject thiz,jlong torchStateLocation)
{
...
Java_com_torchandroid_neuraltalk_lua_LuaManager_testTorchData(JNIEnv *env, jobject thiz, jlong torchStateLocation) {
