package com.torchandroid.neuraltalk.lua;
...
public class LuaManager {
	...
	private native String getImageCaption(long stateLocation, int width, int height,
			byte[] bitmapRGBData);
	...
	public String getImageCaptioningResult(int width, int height,
			byte[] bitmapRGBData) {
		return getImageCaption(mTorchState, width, height, bitmapRGBData);
	}
